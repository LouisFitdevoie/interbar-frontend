    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <AppText style={styles.text}>
          ...
          commandes, si vous êtes vendeur lors d'un évènement. Vos nom et prénom
          pourront être vus sur l'application par l'organisateur des évènements
          auxquels vous participerez ainsi que par les vendeurs de ceux-ci.
        </AppText>
        <AppText style={styles.subtitle}>2) Date de naissance</AppText>
        <AppText style={styles.text}>
          Votre date de naissance sera utilisée uniquement pour vérifier si vous
          êtes en âge de boire ou de vendre de l'alcool. Votre date de naissance
          ne sera pas visible sur l'application, sauf par vous.
        </AppText>
